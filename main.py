...
if user == "1" or user == "CALCULATOR":
    ...
    time.sleep(0.020)
    print(" (8). [12] Subjects  ")
    limit = input(" EnterLimit Subjects: ")
    if limit == "3" or limit == "7":
        g1 = int(input("Enter Grade: "))
        g2 = int(input("Enter Grade: "))
        g3 = int(input("Enter Grade: "))
        g4 = int(input("Enter Grade: "))
        g5 = int(input("Enter Grade: "))
        g6 = int(input("Enter Grade: "))
        g7 = int(input("Enter Graee: "))
        add = g1 + g2 + g3 + g4 + g5 + g6 + g7
        avarage = add / 7 
        time.sleep(0.3)
        ...
        g6 = int(input("Enter Grade: "))
        g7 = int(input("Enter Graee: "))
        g8 = int(input("Enter Grade: "))
        add = g1 + g2 + g3 + g4 + g5 + g6 + g7 + g8 
        avarage = add / 8
        time.sleep(0.3)
        print("Total Avarage is ", avarage)
        ...
        g7 = int(input("Enter Graee: "))
        g8 = int(input("Enter Grade: "))
        g9 = int(input("Emter Grade: "))
        add = g1 + g2 + g3 + g4 + g5 + g6 + g7 + g8 + g9
        avarage = add / 9
        time.sleep(0.3)
        print("Total Avarage is ", avarage)
        ...
        g7 = int(input("Enter Graee: "))
        g8 = int(input("Enter Grade: "))
        g9 = int(input("Enter Grade: "))
        g10  = int(input("Enter Grade: "))
        add = g1 + g2 + g3 + g4 + g5 + g6 + g7 + g8 + g9 + g10
        avarage = add / 10
        time.sleep(0.3)
        print("Total Avarage is ", avarage)
        ...
        g9 = int(input("Enter Grade: "))
        g10 = int(input("Enter Grade: "))
        g11 = int(input("Enter Grade: "))
        add = g1 + g2 + g3 + g4 + g5 + g6 + g7 + g8 + g9 + g10 + g11
        avarage = add / 11
        time.sleep(0.2)
        print("Total Avarage is ", avarage)
        ...
        g10 = int(input("Enter Grade: "))
        g11 = int(input("Enter Grade: "))
        g12 = int(input("Enter Grade: "))
        add = g1 + g2 + g3 + g4 + g5 + g6 + g7 + g8 + g9 + g10 + g11 + g12
        avarage = add / 12 
        print("Total Avarage is ", avarage)
